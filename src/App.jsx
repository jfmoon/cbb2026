...
function MatchupCard({ matchup, onTeamClick, scores }) {
...
// ── Matchups Tab ──────────────────────────────────────────────────────────────
function MatchupsTab({ onTeamClick, scores, lastUpdate }) {
...
export default function App() {
  ...
  const { scores, lastUpdate } = useScores();  // "classifier" | "matchups" | "glossary"
